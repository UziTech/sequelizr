...
yargs(hideBin(process.argv))
    ...
    const { host, database, tables, username, password, port, dialect, models, quiet, sort, config, } = args;
    cmd
        .options({
        host,
        database,
    ...
    const { host, database, tables, username, password, port, dialect, directory, quiet, sort, config, } = argv;
    const options = {
        host,
        database,
        tables,
    ...
    const { host, database, tables, username, password, port, dialect, models, overwrite, quiet, sort, config, } = args;
    ...
    const { host, database, tables, username, password, port, dialect, directory, overwrite, quiet, sort, config, } = argv;
    const options = {
        host,
        database,
        tables,
    ...
    const { host, database, tables, username, password, port, dialect, models, overwrite, alter, quiet, sort, config, } = args;
    ...
    const { host, database, tables, username, password, port, dialect, directory, overwrite, alter, quiet, sort, config, } = argv;
    const options = {
        host,
        database,
        tables,
