...
export class AutoSequelize {
    ...
    startedAt = 0;
    finishedAt = 0;
    constructor(databaseOrSequelize, usernameOrOptions, password, options) {
        let database;
        let username;
            ...
            if (options.dialect === "sqlite" && !options.storage) {
                ...
                options.dialectOptions = {
                    ...
                    options: {
                        ...
                        ...("options" in dialectOptions ? dialectOptions.options : {}),
                    },
                };
    ...
    async writeTable(table, text) {
        ...
        try {
            ...
            if (ex instanceof Error && "code" in ex && ex.code === "EEXIST") {
